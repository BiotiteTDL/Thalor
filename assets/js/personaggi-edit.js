(function(){
  ...
  const DEFAULTS=[
    {
        ...
        "eventsHtml": "<p>Durante la veglia di <a class=\"lore-link\" href=\"../personaggi/dettaglio.html?id=varek\">Varek Thorm</a>, Abraxas entrò a <a class=\"lore-link\" href=\"../luoghi/valkren/index.html\">Villa Thorm</a> mostrando alle guardie solo una parte delle proprie lame. Quando il Libro Mastro venne trafugato, fu tra i primi a lanciarsi all’inseguimento del ladro sui tetti dell’Insenno.</p>\n<p>Dopo la cappella abbandonata, mentre il resto del gruppo tornava alla villa, Abraxas si separò dagli altri per compiere un piccolo rito alle mosche. Quella stessa notte tornò alla veglia e lanciò una bottiglia incendiaria contro la bara di Varek, incendiando il falso cadavere e ferendo gravemente <a class=\"lore-link\" href=\"../personaggi/dettaglio.html?id=lyria\">Lyria Thorm</a>.</p>\n<p>Il giorno seguente tentò di piegare Lyria con parole crudeli durante il funerale, ma la ragazza non cedette. Più tardi, paradossalmente, fu proprio lui a trattare con lei per ottenere una nave verso <a class=\"lore-link\" href=\"../luoghi/portogrigio.html\">Portogrigio</a>. Prima della partenza sacrificò l’alchimista del villaggio in un rito osceno dedicato a Belzebù.</p>\n<p>Durante il viaggio in mare combatté i pirati mezzidrow e torturò il loro capitano, ricavandone informazioni sul Disco runico. A Portogrigio seguì i <a class=\"lore-link\" href=\"../luoghi/portogrigio.html\">Becchini della Pioggia</a> fino all’Accademia. Nella terza sessione incontrò <a class=\"lore-link\" href=\"../personaggi/dettaglio.html?id=abdul\">Abdul Alhazred</a>, ottenendo una piccola mosca metallica che si fissò alla sua gola in cambio di un frammento della sua saggezza.</p>",
        "longDesc": "",
        "events": ""
    },
    {
  ...
  async function refreshPersonaggiList(force=false){
    ...
    try{
      ...
      // Pubblico online-first: l'elenco non deve aspettare login/sessione.
  ...
  async function initDetail(){
    ...
    if(!item&&id){
      item=makeLinks({type:'pg',slug:id,name:String(id).replace(/-/g,' ').replace(/\b\w/g,c=>c.toUpperCase()),playerName:'',roleSlug:id,permissionRole:id,desc:'Personaggio non presente nel registro pubblico aggiornato.',img:'assets/img/Thalor16k.jpg',longDesc:'',events:''});
      // Non salvare automaticamente dal pubblico: evita di creare copie base che sovrascrivono l'online.
    }
