...
function bonusTargetLabel(k,save){
  const map={ac:'CA',touch:'CA contatto',flat:'CA sprovvista',attack:'TPC',damage:'Danni',initiative:'Iniziativa',grapple:'Lotta',skill:'Abilità',srCheck:'Superare RI',FOR:'FOR',DES:'DES',COS:'COS',INT:'INT',SAG:'SAG',CAR:'CAR'};
